...
import { Moon, Sun, Menu, X, Bell, Settings, ChevronRight, User, Home, BarChart3, Calendar, Droplets, Coffee, Smartphone, Moon as MoonIcon, Zap, Info, Award, TrendingUp, Heart, Check, CheckCheck, AlertCircle, Flame, Twitter, Instagram, Facebook } from "lucide-react";
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <Card className="max-w-md w-full p-6">
            ...
            <CardFooter className="flex justify-between">
              <Button variant="outline" onClick={() => setShowAddHabitModal(false)}>Cancel</Button>
